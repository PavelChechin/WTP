...
namespace WTPCoreExample
{
    static class XmlConst
    {
        ...
        public static string OOP = "{http://tempuri.org/dsMMISDB.xsd}ООП";

        public static string Rows = "{http://tempuri.org/dsMMISDB.xsd}ПланыСтроки";

        public static string NewHours = "{http://tempuri.org/dsMMISDB.xsd}ПланыНовыеЧасы";
